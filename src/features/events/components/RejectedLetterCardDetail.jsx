  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 bg-slate-800/40 backdrop-blur-xl border border-slate-700/50 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden">
      ...
      <div className="flex flex-col space-y-5">
        ...
        <div className="rounded-3xl border border-red-500/20 bg-red-500/5 p-5 relative overflow-hidden">
          <AlertCircle className="absolute -right-4 -bottom-4 text-red-500/10" size={90} />
          <div className="relative z-10">
            <div className="flex items-center gap-2 text-red-400">
              <XCircle size={18} />
              <span className="text-xs font-black uppercase tracking-[0.2em]">Rejection Reason</span>
            </div>
            <p className="mt-3 text-red-100 text-base font-medium leading-relaxed">{rejectionText}</p>
            <div className="mt-4 pt-4 border-t border-red-500/10 text-[10px] font-bold uppercase tracking-widest text-red-300/70 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-2.5 h-2.5 rounded-full ${
                        approver.status === "REJECTED" ? "bg-red-500" : "bg-emerald-500"
                      }`}
                    />
                    <div>
